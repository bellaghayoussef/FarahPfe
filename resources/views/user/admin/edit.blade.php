        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">admin Edit</a></li>
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="settings">
                        <form method="POST" class="form-horizontal" action="{{ route('update_admin', $user->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror"
                                        name="nom" value="{{ $user->nom }}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="prenom" type="text"
                                        ...
                                        value="{{ $user->prenom }}" required autocomplete="name" autofocus>
