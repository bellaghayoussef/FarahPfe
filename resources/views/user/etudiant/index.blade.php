        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a type="button" class="btn btn-success float-right" href="{{ route('createetudiant') }}"> <i
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a type="button" class="btn btn-info"
                                                href="{{ route('editetudiant', $user->id) }}"><i class="fa fa-edit"></i>
                                            </a>
                                            <a type="button" class="btn btn-success"
                                                href="{{ route('show_etudiant', $user->id) }}"><i class="fa fa-eye"></i>
                                            </a>


                                            <form action="{{ Route('destroyetudiant', $user->id) }}" class="btn-group"
                                                method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
