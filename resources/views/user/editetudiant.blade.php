            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Etudiant Edit</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                   <form method="POST" class="form-horizontal" action="{{ route('update_etudiant',$user->id) }}" enctype="multipart/form-data" novalidate>
                         {{ csrf_field() }}
        ...
        {!! $errors->first('avatar', '<p class="help-block">:message</p>') !!}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row " id="organisme_div">
                            ...
                            <div class="col-md-6">
                                <input id="organisme" type="text" class="form-control @error('matricule') is-invalid @enderror" value="{{ $user->matricule }}" name="matricule" required>
                        ...
                        <div class="form-group row " id="cin_div">
                            ...
                            <div class="col-md-6">
                                <input id="niveau" type="text" class="form-control @error('niveau') is-invalid @enderror" name="niveau" value="{{ $user->niveau }}" required>
