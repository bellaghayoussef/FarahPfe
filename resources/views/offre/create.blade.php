...
<div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Offre Add </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               <form action="{{ route('offre.store') }}" enctype="multipart/form-data" class="form-horizontal" method="POST">
  {{ csrf_field() }}
  ...
  <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="poste" type="text" class="form-control @error('poste') is-invalid @enderror" name="poste" value="{{ old('name') }}" required autocomplete="name" autofocus>
  ...
  <div class="form-group row">
                      ...
                      <input id="user_id" type="hidden" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ Auth::User()->id }}" required autocomplete="name" autofocus>
                            ...
                            <div class="col-md-6">
                                <input id="salaire" type="number" min="0" class="form-control @error('salaire') is-invalid @enderror" name="salaire" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="col-md-6">
 <input type="text"    name="competence"   data-role="tagsinput" />
                       <!--   <input type="text" class="form-control tag-input" name="tags7" id="tags7"
                       ...
                       -->
                            ...
                            <div class="col-md-6">
                                <input id="deadline" type="date" class="form-control @error('deadline') is-invalid @enderror" name="deadline" value="{{ old('name') }}" required autocomplete="name" autofocus>
...
@endsection
@section('js')
   <script type="text/javascript" src="../js/demo.ts"></script>
